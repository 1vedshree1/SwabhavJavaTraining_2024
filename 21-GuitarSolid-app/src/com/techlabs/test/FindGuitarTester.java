...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
        ...
        GuitarSpec whatErinLikes = new GuitarSpec(Builder.FENDER,"Stratocaster", Type.ACOUSTIC, 8,Wood.INDIAN_ROSEWOOD,Wood.INDIAN_ROSEWOOD);
        List<Guitar> guitar =  inventory.search(whatErinLikes);
        if (!guitar.isEmpty()) {
            System.out.println("Erin, you might like this:");
            for (Guitar guitars : guitar) {
